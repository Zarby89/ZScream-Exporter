...
public class Overworld
{
    ...
    public void DecompressAllMapTiles()
    {
        ...
        for (int i = 0; i < 160; i++)
        {
            ...
            byte[] bytes = Decompress.ALTTPDecompressOverworld(ROM.DATA, p2, 1000, ref compressedSize1);
            byte[] bytes2 = Decompress.ALTTPDecompressOverworld(ROM.DATA, p1, 1000, ref compressedSize2);
